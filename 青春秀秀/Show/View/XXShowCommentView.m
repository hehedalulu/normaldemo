...
#define TimeLineCellHighlightedColor [UIColor blackColor]

@implementation XXShowCommentView
...
- (void)setCommentItemsArray:(NSArray *)commentItemsArray{
    ...
    for (int i = 0; i < commentItemsArray.count; i++) {
        XXShowCommentItemModel *model = commentItemsArray[i];
...
- (void)setLikeItemsArray:(NSArray *)likeItemsArray
{
    ...
    for (int i = 0; i < likeItemsArray.count; i++) {
        XXShowLikeItemModel *model = likeItemsArray[i];
        if (i > 0) {
...
- (NSMutableAttributedString *)generateAttributedStringWithCommentItemModel:(XXShowCommentItemModel *)model{
...
- (NSMutableAttributedString *)generateAttributedStringWithLikeItemModel:(XXShowLikeItemModel *)model{
